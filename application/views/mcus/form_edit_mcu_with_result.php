<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	...
	<form method="POST" action="<?= base_url('mcu/editMcuProcess') ?>" enctype="multipart/form-data" class="p-3 mt-n3">
		...
		<!-- <div class="row mt-3">
			<div class="col-lg-12">
				<div class="card border-danger">
					<div class="card-body">
						<p class="card-title font-weight-bolder text-center mt-2">Hematologi / <i>Haematology</i></p>
						<div class="row">
							<div class="col-lg-12">
								<table width="100%">
									<tbody>
										<tr>
											<td width="15%">
												<label for="haemoglobin" class="mt-1">Haemoglobin (gr/dl)</label>
											</td>
											<td width="32.5%">
												<input class="form-control form-control-sm" type="text" id="haemoglobin" name="haemoglobin" value="<?= $data['haemoglobin'] ?>" required autocomplete="off">
											</td>
											<td width="2.5%"></td>
											<td width="22.5%">
												<label for="white_blood_cell_count" class="mt-1">White Blood Cell Count (Thsn/ul)</label>
											</td>
											<td width="27.5%">
												<input class="form-control form-control-sm" type="text" id="white_blood_cell_count" name="white_blood_cell_count" value="<?= $data['white_blood_cell_count'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="esr" class="mt-1">ESR (mm/hour)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="text" id="esr" name="esr" value="<?= $data['esr'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td>
												<label for="haematoerit" class="mt-1">Haematoerit (%)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="haematoerit" name="haematoerit" value="<?= $data['haematoerit'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="trombosit" class="mt-1">Trombosit (/UL)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="trombosit" name="trombosit" value="<?= $data['trombosit'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td></td>
											<td></td>
						...
						<p class="card-title font-weight-bolder text-center mt-2">Hitungan Diferensial / <i>Differential Count</i></p>
						<div class="row">
							<div class="col-lg-12">
								<table width="100%">
									<tbody>
										<tr>
											<td width="15%">
												<label for="basophil" class="mt-1">Basophil (%)</label>
											</td>
											<td width="32.5%">
												<input class="form-control form-control-sm" type="number" id="basophil" name="basophil" value="<?= $data['basophil'] ?>" required autocomplete="off">
											</td>
											<td width="2.5%"></td>
											<td width="22.5%">
												<label for="eosinophil" class="mt-1">Eosinophil (%)</label>
											</td>
											<td width="27.5%">
												<input class="form-control form-control-sm" type="number" id="eosinophil" name="eosinophil" value="<?= $data['eosinophil'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="stab" class="mt-1">Stab (%)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="stab" name="stab" value="<?= $data['stab'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td>
												<label for="segment" class="mt-1">Segment (%)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="segment" name="segment" value="<?= $data['segment'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="limphocyte" class="mt-1">Limphocyte (%)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="limphocyte" name="limphocyte" value="<?= $data['limphocyte'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td>
												<label for="monocyt" class="mt-1">Monocyt (%)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="monocyt" name="monocyt" value="<?= $data['monocyt'] ?>" required autocomplete="off">
											</td>
										</tr>
									</tbody>
								</table>
						...
						<p class="card-title font-weight-bolder text-center mt-2">Kimia Darah / <i>Blood Chemistry</i></p>
						<div class="row">
							<div class="col-lg-12">
								<table width="100%">
									<tbody>
										<tr>
											<td width="15%">
												<label for="gdp" class="mt-1">GDP (mg/ld)</label>
											</td>
											<td width="32.5%">
												<input class="form-control form-control-sm" type="number" id="gdp" name="gdp" value="<?= $data['gdp'] ?>" required autocomplete="off">
											</td>
											<td width="2.5%"></td>
											<td width="22.5%">
												<label for="blood_sugar_2_pp" class="mt-1">Blood Sugar 2 PP (mg/ld)</label>
											</td>
											<td width="27.5%">
												<input class="form-control form-control-sm" type="number" id="blood_sugar_2_pp" name="blood_sugar_2_pp" value="<?= $data['blood_sugar_2_pp'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="sgot" class="mt-1">SGOT (U/L)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="sgot" name="sgot" value="<?= $data['sgot'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td>
												<label for="sgpt" class="mt-1">SGPT (U/L)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="sgpt" name="sgpt" value="<?= $data['sgpt'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="creatinin" class="mt-1">Creatinin (mg/ld)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="text" id="creatinin" name="creatinin" value="<?= $data['creatinin'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td>
												<label for="total_cholestrol" class="mt-1">Total Cholestrol (mg/ld)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="total_cholestrol" name="total_cholestrol" value="<?= $data['total_cholestrol'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="triglyseride" class="mt-1">Triglyseride (mg/ld)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="triglyseride" name="triglyseride" value="<?= $data['triglyseride'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td>
												<label for="asam_urat" class="mt-1">Asam Urat (mg/ld)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="text" id="asam_urat" name="asam_urat" value="<?= $data['asam_urat'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="ureum" class="mt-1">Ureum (mg/ld)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="ureum" name="ureum" value="<?= $data['ureum'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td>
												<label for="hdl" class="mt-1">HDL (mg/ld)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="hdl" name="hdl" value="<?= $data['hdl'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="ldl" class="mt-1">LDL (mg/ld)</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="number" id="ldl" name="ldl" value="<?= $data['ldl'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td></td>
											<td></td>
						...
						<p class="card-title font-weight-bolder text-center mt-2"><i>Serology / Immunology</i></p>
						<div class="row">
							<div class="col-lg-12">
								<table width="100%">
									<tbody>
										<tr>
											<td width="15%">
												<label for="vdrl" class="mt-1">VDRL</label>
											</td>
											<td width="32.5%">
												<select class="form-control form-control-sm" name="vdrl" id="vdrl" required>
													<option value="" disabled selected>Select Examination Result</option>
													<option value="0" <?= ($data['vdrl'] == '0' ? ('selected') : ('')) ?>>Non Reactive</option>
													<option value="1" <?= ($data['vdrl'] == '1' ? ('selected') : ('')) ?>>Reactive</option>
												</select>
											</td>
											<td width="2.5%"></td>
											<td width="22.5%">
												<label for="hbsag" class="mt-1">HbsAg</label>
											</td>
											<td width="27.5%">
												<select class="form-control form-control-sm" name="hbsag" id="hbsag" required>
													<option value="" disabled selected>Select Examination Result</option>
													<option value="0" <?= ($data['hbsag'] == '0' ? ('selected') : ('')) ?>>Non Reactive</option>
													<option value="1" <?= ($data['hbsag'] == '1' ? ('selected') : ('')) ?>>Reactive</option>
												</select>
											</td>
										</tr>
									</tbody>
						...
						<p class="card-title font-weight-bolder text-center mt-2">Urinalisis / <i>Urinalysis</i></p>
						<div class="row">
							<div class="col-lg-12">
								<table width="100%">
									<tbody>
										<tr>
											<td width="15%">
												<label for="spesific_gravity" class="mt-1">Spesific Gravity</label>
											</td>
											<td width="32.5%">
												<input class="form-control form-control-sm" type="number" id="spesific_gravity" name="spesific_gravity" value="<?= $data['spesific_gravity'] ?>" required autocomplete="off">
											</td>
											<td width="2.5%"></td>
											<td width="22.5%">
												<label for="ph" class="mt-1">PH</label>
											</td>
											<td width="27.5%">
												<input class="form-control form-control-sm" type="text" id="ph" name="ph" value="<?= $data['ph'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="albumin" class="mt-1">Albumin</label>
											</td>
											<td>
												<select class="form-control form-control-sm" name="albumin" id="albumin" required>
													<option value="" disabled selected>Select Examination Result</option>
													<option value="0" <?= ($data['albumin'] == '0' ? ('selected') : ('')) ?>>Negative</option>
													<option value="1" <?= ($data['albumin'] == '1' ? ('selected') : ('')) ?>>Positive</option>
												</select>
											</td>
											<td></td>
											<td>
												<label for="glucose" class="mt-1">Glucose</label>
											</td>
											<td>
												<select class="form-control form-control-sm" name="glucose" id="glucose" required>
													<option value="" disabled selected>Select Examination Result</option>
													<option value="0" <?= ($data['glucose'] == '0' ? ('selected') : ('')) ?>>Negative</option>
													<option value="1" <?= ($data['glucose'] == '1' ? ('selected') : ('')) ?>>Positive</option>
												</select>
											</td>
										</tr>
										<tr>
											<td>
												<label for="epithels_hpf" class="mt-1">Epithels / hpf</label>
											</td>
											<td>
												<select class="form-control form-control-sm" name="epithels_hpf" id="epithels_hpf" required>
													<option value="" disabled selected>Select Examination Result</option>
													<option value="0" <?= ($data['epithels_hpf'] == '0' ? ('selected') : ('')) ?>>Negative</option>
													<option value="1" <?= ($data['epithels_hpf'] == '1' ? ('selected') : ('')) ?>>Positive</option>
												</select>
											</td>
											<td></td>
											<td>
												<label for="wbc_hpf" class="mt-1">WBC / hpf</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="text" id="wbc_hpf" name="wbc_hpf" value="<?= $data['wbc_hpf'] ?>" required autocomplete="off">
											</td>
										</tr>
										<tr>
											<td>
												<label for="rbc_hpf" class="mt-1">RBC / hpf</label>
											</td>
											<td>
												<input class="form-control form-control-sm" type="text" id="rbc_hpf" name="rbc_hpf" value="<?= $data['rbc_hpf'] ?>" required autocomplete="off">
											</td>
											<td></td>
											<td>
												<label for="cast" class="mt-1">Cast</label>
											</td>
											<td>
												<select class="form-control form-control-sm" name="cast" id="cast" required>
													<option value="" disabled selected>Select Examination Result</option>
													<option value="0" <?= ($data['cast'] == '0' ? ('selected') : ('')) ?>>Negative</option>
													<option value="1" <?= ($data['cast'] == '1' ? ('selected') : ('')) ?>>Positive</option>
												</select>
											</td>
										</tr>
										<tr>
											<td>
												<label for="crystal" class="mt-1">Crystal</label>
											</td>
											<td>
												<select class="form-control form-control-sm" name="crystal" id="crystal" required>
													<option value="" disabled selected>Select Examination Result</option>
													<option value="0" <?= ($data['crystal'] == '0' ? ('selected') : ('')) ?>>Negative</option>
													<option value="1" <?= ($data['crystal'] == '1' ? ('selected') : ('')) ?>>Positive</option>
												</select>
											</td>
											<td></td>
											<td>
												<label for="bacteria" class="mt-1">Bacteria</label>
											</td>
											<td>
												<select class="form-control form-control-sm" name="bacteria" id="bacteria" required>
													<option value="" disabled selected>Select Examination Result</option>
													<option value="0" <?= ($data['bacteria'] == '0' ? ('selected') : ('')) ?>>Negative</option>
													<option value="1" <?= ($data['bacteria'] == '1' ? ('selected') : ('')) ?>>Positive</option>
												</select>
											</td>
										</tr>
										<tr>
											<td>
												<label for="other_2" class="mt-1">Others</label>
											</td>
											<td>
												<select class="form-control form-control-sm" name="other_2" id="other_2" required>
													<option value="" disabled selected>Select Examination Result</option>
													<option value="0" <?= ($data['other_2'] == '0' ? ('selected') : ('')) ?>>Negative</option>
													<option value="1" <?= ($data['other_2'] == '1' ? ('selected') : ('')) ?>>Positive</option>
												</select>
											</td>
											<td></td>
											<td></td>
					...
					<div class="card-body">
						<table width="100%">
							<tbody>
								<tr>
									<td align="center">
										<label class="font-weight-bolder" for="comment">Comment on Medical History and Clinical Evaluation</label>
									</td>
								</tr>
								<tr>
									<td>
										<select class="form-control form-control-sm" name="comment" id="comment" required>
											<option value="" disabled selected>Select Comment</option>
											<option value="1" <?= ($data['comment'] == '1' ? ('selected') : ('')) ?>>Fit</option>
											<option value="2" <?= ($data['comment'] == '2' ? ('selected') : ('')) ?>>Fit With Minor Correctable Defect</option>
											<option value="3" <?= ($data['comment'] == '3' ? ('selected') : ('')) ?>>Has Mayor Physical Defect : Fit With Restriction of Selected Assignment</option>
											<option value="4" <?= ($data['comment'] == '4' ? ('selected') : ('')) ?>>UNFIT</option>
										</select>
									</td>
								</tr>
							</tbody>
		...
		<button type="submit" class="btn btn-block btn-warning mt-2"><i class="fas fa-fw fa-save"></i> Ubah / <i>Edit</i></button>
	</form>
</main>
