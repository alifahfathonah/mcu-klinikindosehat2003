<div class="rows main-page">
	<div class="page">
		<div class="row">
			<div class="col-md-8">
				<form action="<?= base_url('mcu/editMcuProcess') ?>" method="POST">
						...
						<div class="col-md-8">
							<?php if ($this->session->userdata('role') == 'superuser') : ?>
								<div class="form-group">
									...
									<select class="form-control form-control-sm value-input-result mt-n1" id="id_clinic" name="id_clinic" required>
							...
							?>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control form-control-sm value-input-result mt-n1" id="id_clinic_name" name="id_clinic_name" value="<?= $clinic_name['name'] ?>" disabled>
								</div>
							<?php endif ?>
							<div class="form-group">
									...
									<div id="collapseVisionExamination" class="collapse show" aria-labelledby="headingOne" data-parent="#visionExamination">
										<div class="card-body p-0" style="padding: 10px !important;">
											...
											<div class="form-group mt-n4">
												...
												<input type="text" class="form-control form-control-sm value-input-result" id="right_eye_without" name="right_eye_without" placeholder="Contoh : 20/20" autocomplete="off" value="<?= $data['right_eye_without'] ?>">
											</div>
											<div class="form-group mt-n2">
												<label class="label-input-result-2 mb-n2" for="left_eye_without">Mata Kiri</label>
												<input type="text" class="form-control form-control-sm value-input-result" id="left_eye_without" name="left_eye_without" placeholder="Contoh : 20/25" autocomplete="off" value="<?= $data['left_eye_without'] ?>">
											</div>
											<div class="form-group mt-n2">
												<label class="label-input-result-2 mb-n2" for="both_eye_without">Kedua Mata</label>
												<input type="text" class="form-control form-control-sm value-input-result" id="both_eye_without" name="both_eye_without" placeholder="Contoh : 20/25" autocomplete="off" value="<?= $data['both_eye_without'] ?>">
											</div>
											<div class="form-group mt-n2">
											...
											<div class="form-group mt-n4">
												...
												<input type="text" class="form-control form-control-sm value-input-result" id="right_eye_with" name="right_eye_with" placeholder="Contoh : 20/20" autocomplete="off" value="<?= $data['right_eye_with'] ?>">
											</div>
											<div class="form-group mt-n2">
												<label class="label-input-result-2 mb-n2" for="left_eye_with">Mata Kiri</label>
												<input type="text" class="form-control form-control-sm value-input-result" id="left_eye_with" name="left_eye_with" placeholder="Contoh : 20/25" autocomplete="off" value="<?= $data['left_eye_with'] ?>">
											</div>
											<div class="form-group mt-n2">
												<label class="label-input-result-2 mb-n2" for="both_eye_with">Kedua Mata</label>
												<input type="text" class="form-control form-control-sm value-input-result" id="both_eye_with" name="both_eye_with" placeholder="Contoh : 20/25" autocomplete="off" value="<?= $data['both_eye_with'] ?>">
											</div>
											<div class="form-group mt-n2">
									...
									<div id="collapsePhysicalExamination" class="collapse show" aria-labelledby="headingOne" data-parent="#physicalExamination">
										<div class="card-body">
											<div class="form-group">
												...
												<input type="text" class="form-control form-control-sm value-input-result" id="height" name="height" placeholder="Contoh : 168 atau 162.8" required autocomplete="off" value="<?= $data['height'] ?>">
											</div>
											<div class="form-group">
												<label class="label-input-result-2" for="weight">Berat Badan (kg)</label>
												<input type="text" class="form-control form-control-sm value-input-result" id="weight" name="weight" placeholder="Contoh : 50 atau 48.8" required autocomplete="off" value="<?= $data['weight'] ?>">
											</div>
											<div class="form-group">
												<label class="label-input-result-2" for="blood_pressure">Tekanan Darah (mmHg)</label>
												<input type="text" class="form-control form-control-sm value-input-result" id="blood_pressure" name="blood_pressure" placeholder="Contoh : 100/70" required autocomplete="off" value="<?= $data['blood_pressure'] ?>">
											</div>
											<div class="form-group">
												<label class="label-input-result-2" for="pulse_regular">Pulse Regular (X/min)</label>
												<input type="text" class="form-control form-control-sm value-input-result" id="pulse_regular" name="pulse_regular" placeholder="Contoh : 84 atau 85.4" required autocomplete="off" value="<?= $data['pulse_regular'] ?>">
											</div>
											<div class="form-group">
												<label class="label-input-result-2" for="respiratory_rate">Respiratory Rate (X/min)</label>
												<input type="text" class="form-control form-control-sm value-input-result" id="respiratory_rate" name="respiratory_rate" placeholder="Contoh : 20" required autocomplete="off" value="<?= $data['respiratory_rate'] ?>">
											</div>
										</div>
									</div>
								</div>
										...
										<div class="card-body">
											<div class="row">
												<div class="col-md-12 text-center mb-2">
													<div class="form-check form-check-inline">
														<input class="form-check-input" type="checkbox" id="allexam" onclick="if(this.checked){myFunction1()}else{myFunction2()}" <?= ($is_all_examine == 1) ? ('checked') : ('') ?>>
					...
					<div class="row mt-3 mr-1">
						<div class="col-md-12">
							...
							<div class="form-group mt-n1">
								...
								<textarea class="form-control value-input-result mt-n1" id="details" name="details" rows="3" autocomplete="off"><?= $data['details'] ?></textarea>
							</div>
