<div class="container-page-2">
	<table width="100%">
		<tr>
			<td align="center" colspan="5">
				<span style="font-size: 16px; font-weight: bold;">MEDICAL EXAMINATION REPORT</span>
			</td>
		</tr>
	</table>
	<br>
	...
	<br>
	<table class="view_2" width="100%" cellpadding="1" cellspacing="0" style="border: 1px solid black;">
		<tr>
