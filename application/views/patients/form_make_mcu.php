<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		<h1 class="h3 font-weight-bolder">Buat Hasil Laboratory (MCU)/ <i>Make Laboratory Result (MCU)</i></h1>
	</div>
	<div class="p-3">
		<div class="card">
	...
	<form method="POST" action="<?= base_url('mcu/makeMcu') ?>" enctype="multipart/form-data" class="p-4 mt-n4">
		...
		<button type="submit" class="btn btn-sm btn-block btn-success"><i class="fas fa-fw fa-save"></i> Kirim / <i>Submit</i></button>
	</form>
